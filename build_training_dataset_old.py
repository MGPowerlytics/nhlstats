...
class NHLTrainingDataset:
    ...
    def build_training_dataset(self, min_date: Optional[str] = None) -> pd.DataFrame:
        ...
        where_clause = f"WHERE g.game_date >= '{min_date}'" if min_date else ""
        ...
        query = f"""
            SELECT 
                ...
                h.corsi_l3 as home_corsi_l3,
                h.fenwick_l3 as home_fenwick_l3,
                ...
                h.corsi_l10 as home_corsi_l10,
                h.fenwick_l10 as home_fenwick_l10,
                ...
                a.corsi_l3 as away_corsi_l3,
                a.fenwick_l3 as away_fenwick_l3,
                ...
                a.corsi_l10 as away_corsi_l10,
                a.fenwick_l10 as away_fenwick_l10,
            ...
            WHERE h.corsi_l10 IS NOT NULL 
              AND a.corsi_l10 IS NOT NULL
