#!/usr/bin/env python3
"""
Fetch Kalshi markets for NHL/NBA games and compare with model predictions.
"""
...
def fetch_nba_markets(date_str=None):
    ...
    try:
        ...
        result = api.search_markets("NBA", limit=200)
...
def fetch_nhl_markets(date_str=None):
    ...
    try:
        ...
        result = api.search_markets("NHL", limit=200)
