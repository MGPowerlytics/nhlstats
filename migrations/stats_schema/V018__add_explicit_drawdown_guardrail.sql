...
WITH latest_snapshot AS (
    SELECT
        ...
        COALESCE(pvs.drawdown_gate_active, FALSE) AS drawdown_gate_active,
        NULLIF(pvs.drawdown_gate_reason_code, '')::VARCHAR AS drawdown_gate_reason_code,
        NULLIF(pvs.drawdown_gate_reason_detail, '')::VARCHAR AS drawdown_gate_reason_detail,
...
SELECT
    ...
    CASE
        ...
        WHEN COALESCE(latest_snapshot.drawdown_gate_active, FALSE)
            THEN 'blocked_drawdown'
        ELSE 'eligible'
    ...
    CASE
        ...
        WHEN COALESCE(latest_snapshot.drawdown_gate_active, FALSE)
            THEN COALESCE(latest_snapshot.drawdown_gate_reason_code, 'drawdown_gate_blocked')
        ELSE NULL
    ...
    CASE
        ...
        WHEN COALESCE(latest_snapshot.drawdown_gate_active, FALSE)
            THEN COALESCE(
                latest_snapshot.drawdown_gate_reason_detail,
