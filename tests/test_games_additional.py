...
class TestDataParsing:
    ...
    def test_parse_nhl_game_data(self):
        game_data = {
            "id": 2024020001,
            "gameDate": "2024-01-15",
            "homeTeam": {"id": 6, "name": "Boston Bruins", "abbrev": "BOS"},
            "awayTeam": {"id": 3, "name": "New York Rangers", "abbrev": "NYR"},
        }
            ...
            "resultSets": [
                {
                    ...
                    "rowSet": [["0022300500", "Final", 1610612738, 1610612751]],
                }
            ]
        }
...
class TestFileSaving:
    ...
    def test_save_schedule_json(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            NHLGameEvents(output_dir=tmpdir)
...
class TestDirectoryCreation:
    ...
    def test_output_dir_created(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            NBAGames(output_dir=str(output_dir))
