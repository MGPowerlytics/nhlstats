...
MOCK_GAMES_DATA = [
    ...
    {'winner': 'Djokovic N.', 'loser': 'Federer R.', 'tour': 'ATP', 'date': '2025-01-02'},
    {'winner': 'Swiatek I.', 'loser': 'Sabalenka A.', 'tour': 'WTA', 'date': '2025-01-01'},
]
...
def test_name_normalization():
    ...
    def test_separate_atp_wta_ratings():
        ...
        elo.update("Player A", "Player B", "ATP")  # Player A wins (implicit winner first)
