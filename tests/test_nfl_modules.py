...
class TestOddsComparatorDirect:
    """Direct tests for odds_comparator module."""
    ...
    def test_odds_comparator_platforms(self):
        """Test OddsComparator has expected platforms."""
        from odds_comparator import OddsComparator
    ...
    def test_load_markets_method_exists(self):
        """Test load_markets method exists."""
        from odds_comparator import OddsComparator
        
        comparator = OddsComparator()
        
        assert hasattr(comparator, 'load_markets')
