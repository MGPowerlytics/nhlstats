...
class TestPortfolioOptimizer:
    ...
    def test_filter_opportunities_by_edge(self, optimizer):
        ...
        opportunities = [
            BetOpportunity(
                sport='nba', ticker='T1', bet_on='home', team='A', opponent='B',
                elo_prob=0.75, market_prob=0.70, edge=0.05,
                confidence='HIGH', yes_ask=70, no_ask=30
            ),
            BetOpportunity(
                sport='nba', ticker='T2', bet_on='home', team='C', opponent='D',
                elo_prob=0.72, market_prob=0.70, edge=0.02,
                confidence='MEDIUM', yes_ask=70, no_ask=30
            ),
        ]
    ...
    def test_filter_opportunities_by_confidence(self, optimizer):
        ...
        opportunities = [
            BetOpportunity(
                sport='nba', ticker='T1', bet_on='home', team='A', opponent='B',
                elo_prob=0.70, market_prob=0.60, edge=0.10,
                confidence='HIGH', yes_ask=60, no_ask=40
            ),
            BetOpportunity(
                sport='nba', ticker='T2', bet_on='home', team='C', opponent='D',
                elo_prob=0.65, market_prob=0.55, edge=0.10,
                confidence='MEDIUM', yes_ask=55, no_ask=45
            ),
        ]
    ...
    def test_filter_opportunities_negative_kelly(self, optimizer):
        ...
        opportunities = [
            BetOpportunity(
                sport='nba', ticker='T1', bet_on='home', team='A', opponent='B',
                elo_prob=0.40, market_prob=0.60, edge=-0.20,
                confidence='HIGH', yes_ask=60, no_ask=40
            ),
        ]
    ...
    def test_calculate_portfolio_allocation_single_bet(self, optimizer):
        ...
        opportunities = [
            BetOpportunity(
                sport='nba', ticker='T1', bet_on='home', team='A', opponent='B',
                elo_prob=0.75, market_prob=0.50, edge=0.25,
                confidence='HIGH', yes_ask=50, no_ask=50
            ),
        ]
    ...
    def test_calculate_portfolio_allocation_multiple_bets(self, optimizer):
        ...
        opportunities = [
            ...
            BetOpportunity(
                sport='nba', ticker='T2', bet_on='home', team='C', opponent='D',
                elo_prob=0.72, market_prob=0.55, edge=0.17,
                confidence='HIGH', yes_ask=55, no_ask=45
            ),
        ]
    ...
    def test_calculate_portfolio_allocation_daily_limit(self, optimizer):
        ...
        opportunities = [
            BetOpportunity(
                sport='nba', ticker=f'T{i}', bet_on='home', team=f'A{i}', opponent=f'B{i}',
                elo_prob=0.75, market_prob=0.50, edge=0.25,
                confidence='HIGH', yes_ask=50, no_ask=50
            )
            for i in range(10)
    ...
    def test_calculate_portfolio_allocation_bet_size_limits(self, optimizer):
        ...
        opportunities = [
            BetOpportunity(
                sport='nba', ticker='T1', bet_on='home', team='A', opponent='B',
                elo_prob=0.69, market_prob=0.67, edge=0.02,
                confidence='MEDIUM', yes_ask=67, no_ask=33
            ),
        ]
    ...
    def test_generate_bet_report(self, optimizer):
        ...
        opportunities = [
            BetOpportunity(
                sport='nba', ticker='T1', bet_on='home', team='Lakers', opponent='Celtics',
                elo_prob=0.75, market_prob=0.60, edge=0.15,
                confidence='HIGH', yes_ask=60, no_ask=40
            ),
        ]
