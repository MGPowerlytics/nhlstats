...
# ============================================================
# Extended tests for odds_comparator.py (30% -> higher)
# ============================================================

class TestOddsComparatorExtended:
    """Extended tests for OddsComparator module."""
    ...
    def test_odds_comparator_has_platforms(self):
        """Test OddsComparator has platforms list."""
        from odds_comparator import OddsComparator
    ...
    def test_american_to_probability_positive(self):
        ...
        # +200 means you win $200 on $100 bet
        # Probability = 100 / (200 + 100) = 33.3%
        american = 200
