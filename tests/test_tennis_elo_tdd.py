...
class TestTennisEloFunctionality:
    ...
    def test_update_basic(self):
        ...
        assert (
            elo.get_rating("Playera", tour="ATP") > initial_rating_a
        )  # Winner's rating increases
        assert (
            elo.get_rating("Playerb", tour="ATP") < initial_rating_b
    ...
    def test_base_interface_adaptation_methods(self):
        ...
        elo.update_team("Playera", "Playerb", home_win=1.0, is_neutral=True)
