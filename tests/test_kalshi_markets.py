...
class TestFetchNBAMarkets:
    ...
    @pytest.mark.skip(reason="fetch_nba_markets does not catch credential exceptions - test invalid")
    @patch('kalshi_markets.load_kalshi_credentials')
...
class TestFetchNHLMarkets:
    ...
    @pytest.mark.skip(reason="fetch_nhl_markets does not catch credential exceptions - test invalid")
    @patch('kalshi_markets.load_kalshi_credentials')
