...
class TestBetLoader:
    ...
    def test_get_bets_summary_with_dates(self, temp_db):
        ...
        loader = BetLoader(db_path=temp_db)
        summary = loader.get_bets_summary(start_date='2024-01-01', end_date='2024-12-31')
...
class TestBetTracker:
    ...
    def test_create_bets_table_idempotent(self, temp_db):
        ...
        conn = duckdb.connect(temp_db)
        create_bets_table(conn)
        create_bets_table(conn)  # Should not error
        conn.close()
    ...
    def test_load_fills_from_kalshi_success(self, mock_kalshi):
        ...
        mock_client._get.return_value = {
            'fills': [
                {'trade_id': '123', 'ticker': 'TEST-123', 'side': 'yes'}
            ]
        }
    ...
    def test_get_betting_summary_empty(self, temp_db):
        ...
        summary = get_betting_summary(db_path=temp_db)
    ...
    def test_get_betting_summary_with_date(self, temp_db):
        ...
        summary = get_betting_summary(db_path=temp_db, date='2024-01-01')
