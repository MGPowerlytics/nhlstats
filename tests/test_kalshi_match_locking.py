...
class TestKalshiMatchLocking(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('builtins.open', unittest.mock.mock_open(read_data=b"-----BEGIN RSA PRIVATE KEY-----\n...\n")):
    ...
    def test_get_match_prefix(self):
        ...
        self.assertEqual(self.client.get_match_prefix(t1), self.client.get_match_prefix(t2))

        # Challenger Match
        c1 = "KXATPCHALLENGERMATCH-26JAN20RIBBLA-RIB"
        c2 = "KXATPCHALLENGERMATCH-26JAN20RIBBLA-BLA"
        self.assertEqual(self.client.get_match_prefix(c1), "KXATPCHALLENGERMATCH-26JAN20RIBBLA")
        self.assertEqual(self.client.get_match_prefix(c1), self.client.get_match_prefix(c2))
    ...
    def test_place_bet_allows_if_match_different(self, mock_post, mock_market, mock_reserve, mock_get_positions):
        """
