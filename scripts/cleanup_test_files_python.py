...
def clean_file(filepath, patterns):
    ...
    try:
        ...
        if len(cleaned_lines) < original_len:
            ...
            print(f"Cleaned {filepath}: removed {original_len - len(cleaned_lines)} lines")
            return True
        else:
...
cleanup_tasks = [
    {
        "file": "tests/test_analyze_positions.py",
        "patterns": [r"mock_mkdirs*="]
    },
    {
        "file": "tests/test_bet_metrics_pipeline.py",
        "patterns": [
            r"setup_recommendationss*=",
            r"mock_db_manager_to_test_engines*="
        ]
    },
    {
        "file": "tests/test_coverage_boost4.py",
        "patterns": [r"mock_nfl_datas*="]
    },
    {
    ...
    {
        "file": "tests/test_kalshi_markets.py",
        "patterns": [r"mock_configs*="]
    }
]
