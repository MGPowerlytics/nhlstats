...
from kalshi_markets import fetch_nba_markets, fetch_nhl_markets, fetch_ncaab_markets, fetch_wncaab_markets
...
def find_current_value(sport_name):
    ...
    api_sport_map = {
        ...
        'wncaab': 'basketball_ncaab' # WNCAAB might not be in free tier or same key
    }
    ...
    for km in kalshi_markets:
        ...
        if match:
            ...
            if edge > 0.02:
                ...
                print(f"{match_str[:40]:<40} | {k_prob:6.1%} | {sharp_prob:6.1%} | {edge:+.1%}")
