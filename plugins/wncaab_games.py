...
D1_PROGRAMS = {
    'Duke', 'Connecticut', 'South_Carolina', 'Stanford', 'LSU', 'Iowa', 'Virginia_Tech',
    'Notre_Dame', 'Louisville', 'Tennessee', 'UCLA', 'USC', 'Baylor', 'Texas', 'Maryland',
    'Indiana', 'Ohio_St', 'Michigan', 'Nebraska', 'Georgia', 'Alabama', 'Kentucky', 'Florida',
    'Mississippi_St', 'Arkansas', 'Auburn', 'Vanderbilt', 'Missouri', 'North_Carolina',
    'NC_State', 'Florida_St', 'Miami_FL', 'Syracuse', 'Boston_Col', 'Wake_Forest', 'Clemson',
    ...
    'South_Carolina_St', 'Bethune-Cookman', 'FAMU', 'Jackson_St', 'Alabama_A&M',
    'Alabama_St', 'Alcorn', 'Grambling', 'Prairie_View', 'Southern', 'Texas_Southern',
    'NC_A&T', 'Hampton', 'App_State', 'Coastal_Carolina', 'Georgia_St', 'Georgia_Southern',
    'Old_Dominion', 'JMU', 'VCU', 'George_Mason', 'Richmond', 'Davidson',
    'Dayton', 'Fordham', 'George_Washington', 'La_Salle', 'UMass', 'Rhode_Island', 'St_Bonaventure',
    'Saint_Louis', 'Duquesne', 'St_Joseph\'s', 'Temple', 'Charlotte', 'UAB', 'Rice', 'Tulane',
    'Tulsa', 'UTEP', 'UTSA', 'North_Texas', 'East_Carolina', 'FAU', 'FIU',
    'Middle_Tennessee', 'WKU', 'Louisiana_Tech', 'NMSU',
    'Liberty', 'Jacksonville_St', 'Sam_Houston', 'Kennesaw', 'Bellarmine', 'Queens_NC',
    'Saint_Mary\'s', 'San_Francisco', 'Santa_Clara', 'Pacific', 'Loyola_Marymount',
    'Pepperdine', 'Portland', 'San_Diego', 'Boise_St', 'Colorado_St', 'Fresno_St', 'Nevada',
    'UNLV', 'New_Mexico', 'San_Diego_St', 'San_Jose_St', 'Wyoming', 'Air_Force', 'Utah_St'
}
